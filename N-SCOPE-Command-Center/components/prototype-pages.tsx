...
import { LiveAssetsPage, LiveAuditLogsPanel, LiveClientDetailPage, LiveClientPortalPage, LiveClientsPage, LiveDevicesPage, LiveSiteDetailPage, LiveSitesPage, LiveTicketsPage } from "./live-resource-pages";
...
export function DetailPage({ section, id }: { section: string; id: string }) {
  if (section === "clients") {
    return <LiveClientDetailPage clientId={id} />;
  }

  if (section === "sites") {
    return <LiveSiteDetailPage siteId={id} />;
  }
